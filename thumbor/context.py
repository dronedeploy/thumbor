...
class RequestParameters:
    ...
    @classmethod
    def from_route_arguments(cls, request, kw):
        return cls(
            debug=bool(kw['debug']),
            meta=bool(kw['meta']),
            trim=kw['trim'],
            crop_left=kw['crop_left'],
            crop_top=kw['crop_top'],
            crop_right=kw['crop_right'],
            crop_bottom=kw['crop_bottom'],
            crop=None,
            adaptive=bool(kw['adaptive']),
            full=bool(kw['full']),
            fit_in=bool(kw['fit_in']),
            width=kw['width'],
            height=kw['height'],
            horizontal_flip=bool(kw['horizontal_flip']),
            vertical_flip=bool(kw['vertical_flip']),
            halign=kw['halign'],
            valign=kw['valign'],
            filters=kw['filters'],
            smart=kw['smart'],
